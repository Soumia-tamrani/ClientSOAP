...
/**
 * <p>Classe Java pour listCptsResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="listCptsResponse">
 *   <complexContent>
...
@XmlType(name = "listCptsResponse", propOrder = {
    "_return"
})
public class ListCptsResponse {
